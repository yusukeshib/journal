    ...
    <Layout location={location}>
      ...
      <ul>
        ...
        <li>
          ...
          including Frontend, Back-end, Web Assembly, task processing infra, and
          the OpenGL-based renderer.
        </li>
        <li>
          Designed a flexible and extensible product structure and a file format
          that gives users the ability to compose reusable and complex
        ...
        <li>
          ...
          frame generations and thumbnail/preview generations) processing server
          structure to support 10,000 instance concurrency with high
          availability.
        </li>
        <li>
      ...
      <h4>Gakko</h4>
      <em>Engineering Lead, Software Engineer / 2017 - 2019 / Tokyo, Japan</em>
      <ul>
        <li>
          Gakko was a platform for creating and selling animated story books for
          children.
        </li>
        <li>
          Designed and implemented backend using Rest API server with NodeJs and
          a deployment system on Github CI + AWS.
        </li>
        <li>
          Designed and implemented front end UI app using React and React-Native
          for multiple platforms
        </li>
        <li>
          Designed and implemented canvas renderer with React-fiber for Web and
          iOS (Objective C)
        </li>
        <li>
          Led the digital team, and the product we implemented attracted
          investors, and the engineering team spun out to my next company Fable.
        </li>
      </ul>
      <h4>Semi-transparent Design</h4>
      <em>Engineering Lead, Software Engineer / 2003 - 2017 / Tokyo, Japan</em>
      <ul>
        <li>
        ...
        <li>
          JAXA space center website: Led a project to organize a massive amount
          of documents written by JAXA scientists, and implemented an

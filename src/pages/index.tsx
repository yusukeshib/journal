...
const BlogIndex: React.FC<PageProps> = function BlogIndex({ data, location }) {
  ...
  return (
    <Layout location={location}>
      <h3>このサイトについて</h3>
      <p>
        私は2019年からアメリカのニューヨークでソフトウェアエンジニアとして働いているYusukeと申します。日本生まれ日本育ちです。日本があまり合わず、海外に挑戦することにしました。
        もうアメリカに住み始めてまあまぁの時が経ち、永住権も手に入れて、本腰入れてニューヨークで生き抜く覚悟で、やっとアメリカの複雑さをなんとなく理解でき始めてきたところです。
      </p>
